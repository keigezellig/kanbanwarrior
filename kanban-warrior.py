...
reportsubparsers = report_parser.add_subparsers(title='report types',  description='Valid reports are:')
...
addtobacklog_parser.add_argument('task', help='Task description')
